const EQ_SourceSimMethods = {
        ...
        gearSimOptions: [
            ...
            { id: 'desktop', label: 'Desktop Amp', icon: 'app/icons/desktop.png', sub: 'Clean & Flat', lowF: 10, lowG: 0, highF: 22000, highG: 0 },
            { id: 'laptop', label: 'Laptop', icon: 'app/icons/laptop.png', sub: 'Light Low-Cut', lowF: 40, lowG: -2.5, highF: 16000, highG: -1.5 },
            { id: 'phone', label: 'Phone', icon: 'app/icons/phone.png', sub: 'Mid-Bass Warmth', lowF: 120, lowG: 3.0, highF: 12000, highG: -3.5 },
            { id: 'dongle', label: 'Dongle DAC', icon: 'app/icons/dongle.png', sub: 'Portable Clean', lowF: 80, lowG: 1.5, highF: 18000, highG: -1.0 },
            { id: 'tube', label: 'Tube Amp', icon: 'app/icons/tube.png', sub: 'Warm & Smooth', lowF: 150, lowG: 5.0, highF: 5000, highG: -4.5 },
            { id: 'adapter10', label: '10Ω Adapter', icon: 'app/icons/impedance.png', sub: '+1.5dB Bass Boost', lowF: 120, lowG: 1.5, highF: 14000, highG: -1.0 },
            { id: 'adapter20', label: '20Ω Adapter', icon: 'app/icons/impedance.png', sub: '+2.5dB Bass Boost', lowF: 140, lowG: 2.5, highF: 12000, highG: -2.0 },
            { id: 'adapter30', label: '30Ω Adapter', icon: 'app/icons/impedance.png', sub: '+3.5dB Bass Boost', lowF: 150, lowG: 3.5, highF: 10000, highG: -3.0 },
            { id: 'adapter50', label: '50Ω Adapter', icon: 'app/icons/impedance.png', sub: '+5.0dB Bass Boost', lowF: 160, lowG: 5.0, highF: 8000, highG: -4.0 },
            { id: 'adapter75', label: '75Ω Adapter', icon: 'app/icons/impedance.png', sub: '+7.0dB Bass Boost', lowF: 180, lowG: 7.0, highF: 6000, highG: -5.0 },
            { id: 'adapter100', label: '100Ω Adapter', icon: 'app/icons/impedance.png', sub: '+9.0dB Bass Boost', lowF: 200, lowG: 9.0, highF: 5000, highG: -6.0 }
        ],
        currentGearIdx: 0,
